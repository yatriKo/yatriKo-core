...
const DiscoverJourney = () => {
  return (
    <div className="min-h-screen w-full bg-white mt-[80px]">
      <div className="max-w-4xl mx-auto p-5 text-center text-[#264653]">
        <h1 className="text-4xl mb-5 font-bold font-['Nirmala_UI',sans-serif]">
        ...
        <p className="text-lg font-bold font-['Newsreader',serif] mt-8">
          Yatriको make travel simple and hassle-free with easy bookings for
          destinations, guesthouses, and bus seats. <br />
          Our goal is to provide seamless experiences so you can focus on
