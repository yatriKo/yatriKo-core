  ...
  const services = [
    {
      ...
      description:
        "Explore exciting destinations with our curated travel options, ensuring a memorable experience wherever you go.",
      link: "/destinations",
    },
    {
      icon: FaBed,
      ...
      description:
        "Find and book comfortable guesthouses that suit your budget and preferences for a relaxing stay.",
      link: "/destinations",
    },
    {
      icon: FaBus,
      ...
      description:
        "Secure your bus seats easily with our hassle-free booking system, ensuring a smooth and convenient journey.",
      link: "/destinations?from=bus",
    },
  ];
